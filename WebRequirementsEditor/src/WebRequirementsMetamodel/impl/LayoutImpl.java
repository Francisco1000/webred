 ...
 * <ul>
 *   <li>{@link WebRequirementsMetamodel.impl.LayoutImpl#getInitialStatus <em>Initial Status</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.LayoutImpl#getSolicitedBy <em>Solicited By</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.LayoutImpl#getImplementedIn <em>Implemented In</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LayoutImpl extends TaskImpl implements Layout {
	/**
	...
	protected EClass eStaticClass() {
		return WebRequirementsMetamodelPackage.Literals.LAYOUT;
	}
	...
	public void setInitialStatus(InitialStatus newInitialStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.LAYOUT__INITIAL_STATUS, oldInitialStatus, initialStatus));
	}
	...
	public void setSolicitedBy(stakeholders newSolicitedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.LAYOUT__SOLICITED_BY, oldSolicitedBy, solicitedBy));
	}
	...
	public void setImplementedIn(RichInternetApplication newImplementedIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.LAYOUT__IMPLEMENTED_IN, oldImplementedIn, implementedIn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebRequirementsMetamodelPackage.LAYOUT__INITIAL_STATUS:
				return getInitialStatus();
			case WebRequirementsMetamodelPackage.LAYOUT__SOLICITED_BY:
				return getSolicitedBy();
			case WebRequirementsMetamodelPackage.LAYOUT__IMPLEMENTED_IN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WebRequirements.class) {
			switch (derivedFeatureID) {
				case WebRequirementsMetamodelPackage.LAYOUT__INITIAL_STATUS: return WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__INITIAL_STATUS;
				case WebRequirementsMetamodelPackage.LAYOUT__SOLICITED_BY: return WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__SOLICITED_BY;
				case WebRequirementsMetamodelPackage.LAYOUT__IMPLEMENTED_IN: return WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__IMPLEMENTED_IN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WebRequirements.class) {
			switch (baseFeatureID) {
				case WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__INITIAL_STATUS: return WebRequirementsMetamodelPackage.LAYOUT__INITIAL_STATUS;
				case WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__SOLICITED_BY: return WebRequirementsMetamodelPackage.LAYOUT__SOLICITED_BY;
				case WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__IMPLEMENTED_IN: return WebRequirementsMetamodelPackage.LAYOUT__IMPLEMENTED_IN;
				default: return -1;
			}
		}
