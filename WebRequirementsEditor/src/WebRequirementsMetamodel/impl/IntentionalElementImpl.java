 ...
 * <ul>
 *   <li>{@link WebRequirementsMetamodel.impl.IntentionalElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IntentionalElementImpl extends EObjectImpl implements IntentionalElement {
	...
	protected EClass eStaticClass() {
		return WebRequirementsMetamodelPackage.Literals.INTENTIONAL_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.INTENTIONAL_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebRequirementsMetamodelPackage.INTENTIONAL_ELEMENT__NAME:
				return getName();
		}
