 ...
 * <ul>
 *   <li>{@link WebRequirementsMetamodel.impl.ContributionImpl#getContributor <em>Contributor</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.ContributionImpl#getContributed <em>Contributed</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.ContributionImpl#getType <em>Type</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.ContributionImpl#getWeightOnClient <em>Weight On Client</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.ContributionImpl#getWeightOnServer <em>Weight On Server</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
