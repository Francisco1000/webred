...
/**
 * This is the item provider adapter for a {@link WebRequirementsMetamodel.Correlation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CorrelationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Correlation_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Correlation_type_feature", "_UI_Correlation_type"),
				 WebRequirementsMetamodelPackage.Literals.CORRELATION__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Correlation)object).getDescription();
