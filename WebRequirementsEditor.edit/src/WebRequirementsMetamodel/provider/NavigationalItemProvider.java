...
/**
 * This is the item provider adapter for a {@link WebRequirementsMetamodel.Navigational} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NavigationalItemProvider
	 ...
	 * @generated
	 */
	public NavigationalItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Navigational"));
	}
	...
	public String getText(Object object) {
		String label = ((Navigational)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Navigational_type") :
			getString("_UI_Navigational_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Navigational.class)) {
