 ...
 * @generated
 */
public class WebRequirementsMetamodelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public WebRequirementsMetamodelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WebRequirementsMetamodel.diagram.navigator.WebRequirementsMetamodelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((WebRequirementsMetamodel.diagram.navigator.WebRequirementsMetamodelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WebRequirementsMetamodel.diagram.navigator.WebRequirementsMetamodelDomainNavigatorItem(
