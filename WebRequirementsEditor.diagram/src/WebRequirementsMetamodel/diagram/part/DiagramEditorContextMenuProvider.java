...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private WebRequirementsMetamodel.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new WebRequirementsMetamodel.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
