...
public class SoftgoalEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.SoftgoalItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.SoftgoalNameEditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.SoftgoalNameEditPart) childEditPart)
