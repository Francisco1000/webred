 ...
 * @generated
 */
public class Content2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Content2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.Content2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ContentFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.ContentName2EditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.ContentName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureContentNameFigure());
			return true;
		}
		return false;
	}
	...
	public class ContentFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureContentNameFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureContentCriticalityFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureContentEvaluationFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureContentInitialStatusFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureContentSolicitedByFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureContentImplementedInFigure;
		...
		private void createContents() {
			...
			fFigureContentNameFigure = new WrappingLabel();
			fFigureContentNameFigure.setText("<...>");

			this.add(fFigureContentNameFigure);

			fFigureContentCriticalityFigure = new WrappingLabel();
			fFigureContentCriticalityFigure.setText("<...>");

			this.add(fFigureContentCriticalityFigure);

			fFigureContentEvaluationFigure = new WrappingLabel();
			fFigureContentEvaluationFigure.setText("<...>");

			this.add(fFigureContentEvaluationFigure);

			fFigureContentInitialStatusFigure = new WrappingLabel();
			fFigureContentInitialStatusFigure.setText("<...>");

			this.add(fFigureContentInitialStatusFigure);

			fFigureContentSolicitedByFigure = new WrappingLabel();
			fFigureContentSolicitedByFigure.setText("<...>");

			this.add(fFigureContentSolicitedByFigure);

			fFigureContentImplementedInFigure = new WrappingLabel();
			fFigureContentImplementedInFigure.setText("<...>");

			this.add(fFigureContentImplementedInFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureContentNameFigure() {
			return fFigureContentNameFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureContentCriticalityFigure() {
			return fFigureContentCriticalityFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureContentEvaluationFigure() {
			return fFigureContentEvaluationFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureContentInitialStatusFigure() {
			return fFigureContentInitialStatusFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureContentSolicitedByFigure() {
			return fFigureContentSolicitedByFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureContentImplementedInFigure() {
			return fFigureContentImplementedInFigure;
		}
