 ...
 * @generated
 */
public class Personalization2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Personalization2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.Personalization2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PersonalizationFigure();
	}

	/**
	 * @generated
	 */
	public PersonalizationFigure getPrimaryShape() {
		return (PersonalizationFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.PersonalizationName2EditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.PersonalizationName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePersonalizationNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class PersonalizationFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePersonalizationNameFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePersonalizationCriticalityFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePersonalizationEvaluationFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePersonalizationInitialStatusFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePersonalizationSolicitedByFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePersonalizationImplementedInFigure;

		/**
		 * @generated
		 */
		public PersonalizationFigure() {
		...
		private void createContents() {
			...
			fFigurePersonalizationNameFigure = new WrappingLabel();
			fFigurePersonalizationNameFigure.setText("<...>");

			this.add(fFigurePersonalizationNameFigure);

			fFigurePersonalizationCriticalityFigure = new WrappingLabel();
			fFigurePersonalizationCriticalityFigure.setText("<...>");

			this.add(fFigurePersonalizationCriticalityFigure);

			fFigurePersonalizationEvaluationFigure = new WrappingLabel();
			fFigurePersonalizationEvaluationFigure.setText("<...>");

			this.add(fFigurePersonalizationEvaluationFigure);

			fFigurePersonalizationInitialStatusFigure = new WrappingLabel();
			fFigurePersonalizationInitialStatusFigure.setText("<...>");

			this.add(fFigurePersonalizationInitialStatusFigure);

			fFigurePersonalizationSolicitedByFigure = new WrappingLabel();
			fFigurePersonalizationSolicitedByFigure.setText("<...>");

			this.add(fFigurePersonalizationSolicitedByFigure);

			fFigurePersonalizationImplementedInFigure = new WrappingLabel();
			fFigurePersonalizationImplementedInFigure.setText("<...>");

			this.add(fFigurePersonalizationImplementedInFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePersonalizationNameFigure() {
			return fFigurePersonalizationNameFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePersonalizationCriticalityFigure() {
			return fFigurePersonalizationCriticalityFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePersonalizationEvaluationFigure() {
			return fFigurePersonalizationEvaluationFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePersonalizationInitialStatusFigure() {
			return fFigurePersonalizationInitialStatusFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePersonalizationSolicitedByFigure() {
			return fFigurePersonalizationSolicitedByFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePersonalizationImplementedInFigure() {
			return fFigurePersonalizationImplementedInFigure;
		}
