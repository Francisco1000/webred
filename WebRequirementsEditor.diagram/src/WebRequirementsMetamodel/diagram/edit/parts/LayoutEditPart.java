 ...
 * @generated
 */
public class LayoutEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LayoutEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.LayoutItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.LayoutNameEditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.LayoutNameEditPart) childEditPart)
