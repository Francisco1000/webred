...
public class ActorEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.ActorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new WebRequirementsMetamodel.diagram.edit.policies.ActorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.ActorDescriptionEditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.ActorDescriptionEditPart) childEditPart)
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(450, 450);
		return result;
	}
	...
	public class ActorFigure extends Ellipse {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureActorEvaluationFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureActorCriticalityFigure;
		/**
		 * @generated
		 */
		...
		public ActorFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(450),
					getMapMode().DPtoLP(450)));
		...
		private void createContents() {
			...
			fFigureActorNameFigure
					.setText("This element respresents a Stakeholder, also a WebApplication");

			fFigureActorNameFigure.setFont(FFIGUREACTORNAMEFIGURE_FONT);

			this.add(fFigureActorNameFigure);

			fFigureActorCriticalityFigure = new WrappingLabel();
			fFigureActorCriticalityFigure.setText("");

			this.add(fFigureActorCriticalityFigure);

			fFigureActorEvaluationFigure = new WrappingLabel();
			fFigureActorEvaluationFigure.setText("");

			this.add(fFigureActorEvaluationFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActorEvaluationFigure() {
			return fFigureActorEvaluationFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureActorCriticalityFigure() {
			return fFigureActorCriticalityFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 122, 249, 255);
