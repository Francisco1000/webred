 ...
 * @generated
 */
public class NavigationalEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NavigationalEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.NavigationalItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.NavigationalNameEditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.NavigationalNameEditPart) childEditPart)
