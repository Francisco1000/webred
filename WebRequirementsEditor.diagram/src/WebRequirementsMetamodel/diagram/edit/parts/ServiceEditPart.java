...
public class ServiceEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new WebRequirementsMetamodel.diagram.edit.policies.ServiceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebRequirementsMetamodel.diagram.edit.parts.ServiceNameEditPart) {
			((WebRequirementsMetamodel.diagram.edit.parts.ServiceNameEditPart) childEditPart)
