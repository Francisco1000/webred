...
public class ActorCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return WebRequirementsMetamodel.WebRequirementsMetamodelPackage.eINSTANCE
				.getActor_StrategicRelationships();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<WebRequirementsMetamodel.diagram.part.WebRequirementsMetamodelNodeDescriptor> childDescriptors = WebRequirementsMetamodel.diagram.part.WebRequirementsMetamodelDiagramUpdater
				.getActor_2007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return WebRequirementsMetamodel.diagram.edit.parts.SREditPart.VISUAL_ID == WebRequirementsMetamodel.diagram.part.WebRequirementsMetamodelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebRequirementsMetamodel.diagram.part.WebRequirementsMetamodelNodeDescriptor> childDescriptors = WebRequirementsMetamodel.diagram.part.WebRequirementsMetamodelDiagramUpdater
				.getActor_2007SemanticChildren((View) getHost().getModel());
