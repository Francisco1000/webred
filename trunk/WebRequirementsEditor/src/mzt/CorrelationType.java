...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Correlation Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see mzt.WebRequirementsMetamodelPackage#getCorrelationType()
 * @model
 * @generated
 */
public enum CorrelationType implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	SOME_POSITIVE(5, "somePositive", "somePositive"),
	 ...
	 * @ordered
	 */
	public static final int SOME_POSITIVE_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int MAKE_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int HELP_VALUE = 6;

	/**
	 * An array of all the '<em><b>Correlation Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CorrelationType[] VALUES_ARRAY =
		new CorrelationType[] {
			BREAK,
			HURT,
			SOME_NEGATIVE,
	...
	/**
	 * A public read-only list of all the '<em><b>Correlation Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CorrelationType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Correlation Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CorrelationType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CorrelationType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Correlation Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CorrelationType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CorrelationType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Correlation Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CorrelationType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CorrelationType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
