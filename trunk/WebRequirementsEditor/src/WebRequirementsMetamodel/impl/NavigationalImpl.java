...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Navigational</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link WebRequirementsMetamodel.impl.NavigationalImpl#getInitialStatus <em>Initial Status</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.NavigationalImpl#getSolicitedBy <em>Solicited By</em>}</li>
 *   <li>{@link WebRequirementsMetamodel.impl.NavigationalImpl#getImplementedIn <em>Implemented In</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NavigationalImpl extends TaskImpl implements Navigational {
	/**
	...
	protected EClass eStaticClass() {
		return WebRequirementsMetamodelPackage.Literals.NAVIGATIONAL;
	}
	...
	public void setInitialStatus(InitialStatus newInitialStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.NAVIGATIONAL__INITIAL_STATUS, oldInitialStatus, initialStatus));
	}
	...
	public void setSolicitedBy(stakeholders newSolicitedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.NAVIGATIONAL__SOLICITED_BY, oldSolicitedBy, solicitedBy));
	}
	...
	public void setImplementedIn(RichInternetApplication newImplementedIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebRequirementsMetamodelPackage.NAVIGATIONAL__IMPLEMENTED_IN, oldImplementedIn, implementedIn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebRequirementsMetamodelPackage.NAVIGATIONAL__INITIAL_STATUS:
				return getInitialStatus();
			case WebRequirementsMetamodelPackage.NAVIGATIONAL__SOLICITED_BY:
				return getSolicitedBy();
			case WebRequirementsMetamodelPackage.NAVIGATIONAL__IMPLEMENTED_IN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WebRequirements.class) {
			switch (derivedFeatureID) {
				case WebRequirementsMetamodelPackage.NAVIGATIONAL__INITIAL_STATUS: return WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__INITIAL_STATUS;
				case WebRequirementsMetamodelPackage.NAVIGATIONAL__SOLICITED_BY: return WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__SOLICITED_BY;
				case WebRequirementsMetamodelPackage.NAVIGATIONAL__IMPLEMENTED_IN: return WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__IMPLEMENTED_IN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WebRequirements.class) {
			switch (baseFeatureID) {
				case WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__INITIAL_STATUS: return WebRequirementsMetamodelPackage.NAVIGATIONAL__INITIAL_STATUS;
				case WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__SOLICITED_BY: return WebRequirementsMetamodelPackage.NAVIGATIONAL__SOLICITED_BY;
				case WebRequirementsMetamodelPackage.WEB_REQUIREMENTS__IMPLEMENTED_IN: return WebRequirementsMetamodelPackage.NAVIGATIONAL__IMPLEMENTED_IN;
				default: return -1;
			}
		}
